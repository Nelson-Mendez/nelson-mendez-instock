        ...
        <div className="OneProduct__container">
          ...
          <div className="OneProduct__all-sections-container">
            <div className="OneProduct__section-container OneProduct__section-container--description">
              <h3 className="OneProduct__title">Item Description</h3>
            ...
            <div className="OneProduct__information-container">
              <div className="OneProduct__sections-container">
                <div className="OneProduct__section-container">
                  <h3 className="OneProduct__title">ORDERED BY</h3>
                  <p className="OneProduct__info">
                ...
                <div className="OneProduct__section-container">
                  <h3 className="OneProduct__title">Reference Number</h3>
                  <p className="OneProduct__info">{this.state.itemData.id}</p>
                </div>
              </div>

              <div className="OneProduct__sections-container">
                <div className="OneProduct__section-container">
                  <h3 className="OneProduct__title">Last Ordered</h3>
                  <p className="OneProduct__info">
                ...
                <div className="OneProduct__section-container">
                  <h3 className="OneProduct__title">Location</h3>
                  <p className="OneProduct__info">{this.state.itemData.city}</p>
                </div>
              </div>

              <div className="OneProduct__section-container">
                <h3 className="OneProduct__title">QUANTITY</h3>
                <p className="OneProduct__info">
              ...
              <div className="OneProduct__section-container OneProduct__section-container--category">
                <h3 className="OneProduct__title">Categories</h3>
                <p className="OneProduct__info">
          ...
          <button className="OneProduct__edit-btn">Edit</button>
        </div>
      </div>
    );
  }
